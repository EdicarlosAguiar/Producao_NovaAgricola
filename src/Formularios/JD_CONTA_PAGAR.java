 ...
 * @author Edicarlos
 */
public class JD_CONTA_PAGAR extends javax.swing.JDialog {
    ...
    public JD_CONTA_PAGAR(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void buscaUltimaCompra() {
        ...
        try {
            ...
            pst = conn.getConexao().prepareStatement("select codForn,nomeForn,valorFinal,"
                    + "condPagamento from compra where codigo = ?");
    ...
    public void buscaUltimoTitulo() {
        ...
        try {
            PreparedStatement pst = null;
            ResultSet rs;
            pst = conn.getConexao().prepareStatement("select titulo from contas_pagar");
            rs = pst.executeQuery();
            while (rs.next()) {
                if (rs.equals("")) {
                    txtTitulo.setText(String.valueOf(1));
    ...
    private void initComponents() {
        ...
        jLabel9.setText("  Contas a Pagar - Incluir");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Vincular Compra", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(0, 51, 204))); // NOI18N
        ...
        jLabel2.setText("Cod Comp:");

        jLabel3.setText("Cod Forn:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbTipoDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(124, 124, 124)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
            ...
            if (cbFixaDia.getSelectedItem() == "S") {
                ...
                while (totalParcelas >= contParcela) {
                    ...
                    try {
                        ...
                        Logger.getLogger(JD_CONTA_PAGAR.class.getName()).log(Level.SEVERE, null, ex);
                    }
...
// TODO add your handling code here:
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        Model.ModelContaPagar mod = new ModelContaPagar();
        ControlContaPagar control = new ControlContaPagar();
        ...
        while (totalLinha >= lin) {
            ...
            try {
                ...
                mod.setCodCompra(Integer.parseInt(txtCodCompra.getText()));//Cod Compra
                mod.setCodForn(Integer.parseInt(txtCodForn.getText()));//Cod Fornecedor
                mod.setFornecedor(txtFornecedor.getText());//Nome Fornecedor
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JD_CONTA_PAGAR.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JD_CONTA_PAGAR dialog = new JD_CONTA_PAGAR(new javax.swing.JFrame(), true);
