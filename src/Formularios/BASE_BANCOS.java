 ...
 * @author Edicarlos
 */
public class BASE_BANCOS extends javax.swing.JFrame {
    ...
    public void carregaTabela() {
        ...
        try {
            ...
            ResultSet rs;
            int linha = 1;
            pst = conn.getConexao().prepareStatement("select * from BANCOS");
            rs = pst.executeQuery();
            ...
            while (rs.next()) {

                {
                    modelo.addRow(new Object[]{
                        ...
                        rs.getString("banco").toUpperCase(),
                        rs.getInt("codigo"),
                        rs.getInt("ISPB"),}
                    );
    ...
    public void pesquisaNome() {
        ...
        try {
            ...
            ResultSet rs;
            int linha = 1;
            pst = conn.getConexao().prepareStatement("select * from BANCOS where banco LIKE?");
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cadastro de Bancos");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        pesquisaNome();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASE_BANCOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASE_BANCOS().setVisible(true);
            }
        });
    }
