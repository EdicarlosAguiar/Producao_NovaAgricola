 ...
 * @author Edicarlos
 */
public class BASE_CLIENTE extends javax.swing.JFrame {

    KeyEvent evt;
    String clienteSelecionada;

    public String getClienteSelecionada() {
        return clienteSelecionada;
    }

    public void setClienteSelecionada(String compraSelecionada) {
        this.clienteSelecionada = compraSelecionada;
    }
    ...
    public void configInicias() {
        //Define altura dos titulos de coluna da tabela
            ...
            while (rs.next()) {

                {
                    modelo.addRow(new Object[]{
                        linha,
                        rs.getInt(2),//Codigo
                        rs.getString(3),//Razao Social
                        rs.getString(4),//Nome Fantasia
                        rs.getString(5),//CNPCPFJ
                    }
                    );
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(lblDadosEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 555, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        PainelTabelaTitulosLayout.setHorizontalGroup(
            ...
            .addGroup(PainelTabelaTitulosLayout.createSequentialGroup()
                .addComponent(painelTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 448, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        clienteSelecionada = (String) (tabela.getValueAt(linhaSelecionada, 1).toString());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (clienteSelecionada == null) {
            ...
            cliente.tituloAlterar();
            cliente.pegaCodCliente(this);
            cliente.buscaDadosCliente();
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        JD_CLIENTE cliente = new JD_CLIENTE(this, true);
        cliente.tituloIncluir();
        cliente.geraCodCliente();
        cliente.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASE_CLIENTE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASE_CLIENTE().setVisible(true);
            }
        });
    }
