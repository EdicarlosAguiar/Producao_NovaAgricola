 ...
 * @author Edicarlos
 */
public class BASE_FABRICANTES extends javax.swing.JFrame {

    static String fabricanteSelecionado;

    ModelUsuario user = new ModelUsuario();

    public BASE_FABRICANTES() {
        initComponents();
        carregaTabela();
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(lblDadosEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 561, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        JD_FABRICANTE fabricante = new JD_FABRICANTE(new javax.swing.JFrame(), true);
        fabricante.tituloIncluir();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASE_FABRICANTES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASE_FABRICANTES().setVisible(true);
            }
        });
    }
