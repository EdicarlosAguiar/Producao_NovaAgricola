 ...
 * @author Edicarlos
 */
public class BASE_CATEGORIA extends javax.swing.JFrame {
            ...
            while (rs.next()) {

                {
                    ...
                    if (rs.getInt(2) < 10) {
                        ...
                        String codCat = String.valueOf(rs.getInt(2));
                        modelo.addRow(new Object[]{
                            linha,
                            codCat,//Sequencial
                            rs.getString(3),//Data
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Listagem de Categorias");
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
      ...
      /*  try {
            ...
            comandoSQL = Conexao.getConexao().prepareStatement("SELECT `codProduto`,\n"
                    + "	unidade,\n"
                    + "	quantidade,\n"
                    + "	preco,\n"
                    + "	total\n"
                    + "FROM edicarlos.compra");

            ResultSet rs = comandoSQL.executeQuery();

            JRResultSetDataSource relResult = new JRResultSetDataSource(rs);
            JasperPrint jpPrint = JasperFillManager.fillReport("C:\\Users\\edica\\Documents\\NetBeansProjects\\DULCECONTROL - Copia\\src\\relatorios\\Compra.jasper", null, relResult);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (categoriaSelecionada == null) {
            ...
            JF_CATEGORIA cat = new JF_CATEGORIA(this, true);
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        JF_CATEGORIA categoria = new JF_CATEGORIA(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASE_CATEGORIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASE_CATEGORIA().setVisible(true);
            }
        });
    }
