 ...
 * @author Edicarlos
 */
public class BASE_CONTAS_BANCO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Listagem de contas em banco");
...
//            cat.pegaCategoria(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASE_CONTAS_BANCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASE_CONTAS_BANCO().setVisible(true);
            }
        });
    }
