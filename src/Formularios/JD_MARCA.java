 ...
 * @author Edicarlos
 */
public class JD_MARCA extends javax.swing.JDialog {
     ...
     */
    public JD_MARCA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void tituloIncluir() {
        lblTitulo.setText("Cadastro de Marcas - Incluir");
    }

    public void parametrosAlterar() {
        lblTitulo.setText("Cadastro de Marcas - Alterar");

    }

    public void pegaMarca(BASE_MARCAS marca) {
        txtCodigo.setText(marca.getMarcaSelecionada());
    }

    public void parametrosExcluir() {
        lblTitulo.setText("Cadastro de Marcas - Excluir");
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Nome da Marca");
    ...
    private void brnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brnConfirmarActionPerformed
        ...
        String salvar = "Cadastro de Marcas - Incluir";
        String alterar = "Cadastro de Categoria - Alterar";
        String excluir = "Cadastro de Categora - Excluir";

        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy" + " hh:mm:ss");

        try {
            PreparedStatement pst = conn.getConexao().prepareStatement("insert into marca(codigo,marca)VALUES(?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JD_MARCA.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JD_MARCA dialog = new JD_MARCA(new javax.swing.JFrame(), true);
