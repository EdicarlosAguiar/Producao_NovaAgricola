 ...
 * @author Edicarlos
 */
public class ABRIR_CAIXA extends javax.swing.JDialog {
    ...
    public ABRIR_CAIXA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void geraCodCaixa() {
        ...
        try {
            ...
            ResultSet rs;
            pst = conn.getConexao().prepareStatement("select codigo from caixa_pdv");
            rs = pst.executeQuery();
            
            while (rs.next()) {
                int ultimoCodigo = rs.getInt(1);
                int novoCodigo = ultimoCodigo + 1;
                lblCodCaixa.setText(String.valueOf(novoCodigo));
        ...
        if (lblCodCaixa.getText().equals("")) {
            lblCodCaixa.setText(String.valueOf(1));
        } else {
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (lblAprovador.getText().equals("Aprovador inválido")) {
            ...
            modCaixa.setData(this.dataBase);
            modCaixa.setOperador(lblOperador.getText());
            modCaixa.setStatus("ABERTO");
            modCaixa.setSaldo_inical(Double.parseDouble(txtValor.getText().replace("R$ ", "").replace(".", "").replaceAll(",", ".")));//Saldo Inicail
            modCaixa.setOperacao("ABERTURA DE CAIXA");
