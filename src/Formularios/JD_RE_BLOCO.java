 ...
 * @author Desktop
 */
public class JD_RE_BLOCO extends javax.swing.JDialog {
    ...
    public JD_RE_BLOCO(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void carregaTabela() {
        ...
        try {
            ...
            pst = conn.getConexao().prepareStatement("select * from contas_receber where cod_cliente=? and STATUS =? and vencimento_base >=? and vencimento_base <=?");
            ...
            while (rs.next()) {
...

                {
                    modelo.addRow(new Object[]{
                        ...
                        rs.getString("nome_cliente"),//Fornecedor
            ...
            JOptionPane.showMessageDialog(null,"Erro ao processar dados "+ e);
        }
        AlinharColunas();
    }
    ...
    public void carregaTodosFornecedores() {
        ...
        try {
            ...
            pst = conn.getConexao().prepareStatement("select * from contas_receber where STATUS =? and vencimento_base >=? "
                    + "and vencimento_base <=? order by vencimento_base asc, cod_cliente");
            ...
            JOptionPane.showMessageDialog(null,"Erro ao carregar tados "+ e);        }
        AlinharColunas();
    }
    ...
    public void buscaFornecedor() {
        ...
        try {
            ...
            ResultSet rs;
            pst = conn.getConexao().prepareStatement("select razaoSocial from cliente where ID = ?");
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Data Recebimento:");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "", "Titulo", "Cliente", "Vencimento", "Parcela", "Valor ", "Situação", "Nº Doc", "Tipo Doc"
            }
        ) {
        ...
        lblMsgProcessamento.setForeground(new java.awt.Color(0, 102, 102));
        ...
        jLabel1.setText("Contas a receber - pagamento por seleção");
                ...
                public void run() {
                    ...
                    try {
                        ...
                        while (total_linha > increment) {
                            ...
                            boolean salvar = (boolean) tabela.getValueAt(increment, 1);
                            if (salvar == true) {
                                pst = conn.getConexao().prepareStatement("UPDATE contas_receber SET STATUS=?,"
                                        + "DATA_RECEBIMENTO =?, VALOR_RECEBIDO=?, JUROS_MULTAS =?, USER_PG =? where titulo =?");
                                pst.setString(1, "TITULO RECEBIDO");//Atualiza o status do titulo
...
// TODO add your handling code here:
    ...
    private void txtCodFornecedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodFornecedorKeyPressed
        ...
        if (tecla == tecla2) {
            ...
            ConsultaCliente consulta = new ConsultaCliente(null, true);
            consulta.carregaArray();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JD_RE_BLOCO.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JD_RE_BLOCO dialog = new JD_RE_BLOCO(new javax.swing.JFrame(), true);
