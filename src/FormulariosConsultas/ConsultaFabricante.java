 ...
 * @author Edicarlos
 */
public class ConsultaFabricante extends javax.swing.JDialog {
    ...
    public ConsultaFabricante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregaTabela();
    ...
    public void buscaProduto() {
        ...
        try {
            ...
            pst = conn.getConexao().prepareStatement("select * from categoria where categoria LIKE?");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Categoria de Produtos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaFabricante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaFabricante dialog = new ConsultaFabricante(new javax.swing.JFrame(), true);
