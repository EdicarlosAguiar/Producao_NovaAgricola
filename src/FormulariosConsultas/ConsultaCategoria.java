...
public class ConsultaCategoria extends javax.swing.JDialog {
    ...
    private static ArrayList<String> arrayCategoria = new ArrayList();

    public ArrayList<String> getArrayCategoria() {
...
//        carregaTabela();
    ...
    public void carregaTabela() {
        ...
        DefaultTableModel modelo = (DefaultTableModel) tabela.getModel();
        modelo.setNumRows(0);
        int totalItem = arrayCategoria.size();
        int i = 0;
        while (totalItem > i) {
            {
                modelo.addRow(new Object[]{
                    tabela.getRowCount() + 1,
                    arrayCategoria.get(i),//Codigo
                    arrayCategoria.get(i + 1),//Categoria
                }
                );
    ...
    public void carregaArray() {
        ...
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()) {
                arrayCategoria.add(rs.getString("codigo"));
                arrayCategoria.add(rs.getString("categoria"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta Padrão - Categoria de Produto");
