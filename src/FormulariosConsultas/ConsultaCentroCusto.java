 ...
 * @author Edicarlos
 */
public class ConsultaCentroCusto extends javax.swing.JDialog {
    ...
    public ConsultaCentroCusto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        carregaTabela();
    ...
    public void carregaTabela() {
        ...
        modelo.setNumRows(0);
        try {
            int totalItem = centro_custo.size();
            int i = 0;
            while (totalItem >= i) {
                {
                    modelo.addRow(new Object[]{
                        tabela.getRowCount(),
                        centro_custo.get(i),//Codigo
                        centro_custo.get(i + 1),//Categoria
                    }
                    );
                }
                i = i+2;
    ...
    public void carregaArray() {
        ...
        try {
            ...
            pst = conn.getConexao().prepareStatement("select * from centro_custo");
            rs = pst.executeQuery();

            while (rs.next()) {

                centro_custo.add(rs.getString("codigo"));//Codigo
                centro_custo.add(rs.getString("DESCRICAO"));//Categoria
            }
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Indece", "Centro de Custo", "Descrição"
            }
        ) {
        ...
        jLabel1.setText("Consulta Padrão - Centro de Custos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaCentroCusto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultaCentroCusto dialog = new ConsultaCentroCusto(new javax.swing.JFrame(), true);
