 ...
 * @author Edicarlos
 */
public class senhaInvalida extends javax.swing.JDialog {

    /**
     * Creates new form AcessoNegado
     */
    public senhaInvalida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                senhaInvalida dialog = new senhaInvalida(new javax.swing.JFrame(), true);
