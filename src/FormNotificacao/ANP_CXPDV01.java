 ...
 * @author Edicarlos
 */
public class ANP_CXPDV01 extends javax.swing.JDialog {

    /**
     * Creates new form AcessoNegado
     */
    public ANP_CXPDV01(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O CAIXA JÁ SE ENCONTRA FECHADO!");
        ...
        jLabel5.setText("Não é possivel realizar dois fechamentos para o mesmo caixa.");

        jLabel7.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabel7.setText("Selecione outro caixa para fechamento.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ANP_CXPDV01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ANP_CXPDV01 dialog = new ANP_CXPDV01(new javax.swing.JFrame(), true);
