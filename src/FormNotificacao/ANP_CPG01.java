 ...
 * @author Edicarlos
 */
public class ANP_CPG01 extends javax.swing.JDialog {

    /**
     * Creates new form AcessoNegado
     */
    public ANP_CPG01(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("COMPRA À VISTA!");
        ...
        jLabel5.setText("Não é permitido o lançamento de duplicatas A PAGAR vinculadas a uma compra A VISTA.");
        ...
        jLabel7.setText("Caso realmente se trate de uma compra A PRAZO, altere o lançamento dessa compra.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ANP_CPG01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ANP_CPG01 dialog = new ANP_CPG01(new javax.swing.JFrame(), true);
