 ...
 * @author Edicarlos
 */
public class AcessoNegado extends javax.swing.JDialog {

    /**
     * Creates new form AcessoNegado
     */
    public AcessoNegado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACESSO NÃO PERMITIDO!");

        jLabel4.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Verifique suas credências e tente novamente.");

        jPanel3.setBackground(new java.awt.Color(94, 110, 110));

        jLabel3.setBackground(new java.awt.Color(180, 202, 202));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcessoNegado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AcessoNegado dialog = new AcessoNegado(new javax.swing.JFrame(), true);
